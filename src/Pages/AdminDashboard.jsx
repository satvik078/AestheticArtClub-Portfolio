...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await axios.get("https://aestheticartclub-portfolio.onrender.com/api/gallery");
      setArtList(res.data);
    };
    fetchData();
  }, []);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://aestheticartclub-portfolio.onrender.com/api/admin/delete/${id}`, {
